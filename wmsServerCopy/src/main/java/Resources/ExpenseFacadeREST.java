...
import Database.ConnectionToExpense;
import Service.Expense;
...
public class ExpenseFacadeREST extends AbstractFacade<Expense> {
    ...
    ConnectionToExpense communication;
    ...
    public void postOperation(String s) throws ClassNotFoundException, SQLException, JSONException {
        communication = new ConnectionToExpense();
        communication.postExpense(s);
    }

    @PUT
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Expense entity) {
        super.edit(entity);
    }
    ...
    @Path("{id}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public Expense find(@PathParam("id") Integer id) {
